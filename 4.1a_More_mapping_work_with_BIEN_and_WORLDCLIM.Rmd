...
```{r}
tax_name(q="Petrocoptis hispanica", get="subspecies", db="ncbi")
```
...
#data frame for Minuartia cerastiifolia
```{r}
Planty <- occ(q="Minuartia cerastiifolia", from="gbif", limit=50)
Planty
